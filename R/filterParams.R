...
#'   Vector of allowed types, subset of: \dQuote{numeric}, \dQuote{integer}, \dQuote{numericvector}, \dQuote{integervector}, \dQuote{discrete}, \dQuote{discretevector}, \dQuote{logical}, \dQuote{function}, \dQuote{untyped}.
...
filterParams = function(par.set, type) {
  checkArg(type, subset=c("numeric", "integer", "numericvector", "integervector", "discrete", "discretevector", "logical", "function", "untyped"))
